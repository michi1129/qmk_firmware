...
#define KA_RCMD RGUI_T(KANA)
#define EI_LCMD LGUI_T(EISU)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  |EiLCmd|Lower |Space |Enter |Raise |KaRCmd| Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, EI_LCMD, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KA_RCMD, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      KC_LCTL, KC_A,    KC_O,    KC_E,    KC_I,    KC_U,                      KC_B,    KC_G,    KC_T,    KC_S,    KC_N,    KC_QUOT, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  _______, KC_PSCR, KC_PGDN, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_DEL,  _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
...
float tone_eucalyn[][2]    = SONG(PLANCK_SOUND);  // provisional
